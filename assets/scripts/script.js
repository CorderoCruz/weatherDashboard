    ...
    fetch(cityURL)
        ...
        .then((data) => {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                const latitude = Math.round(latLong.latitude * 100) / 100;
                const longitude = Math.round(latLong.longitude * 100) / 100;
                function convertData() {
                    ...
                    fetch(cityLatLongUrl)
                        ...
                        .then((data) => {
                            ...
                            dayFourHum.textContent = `${data.daily[3].humidity} %`;
                            //----------------LOGS FOR DAY FIVE ----------------------------
                            ...
                            dayFiveHum.textContent = `${data.daily[4].humidity} %`;
                        });
                }
                convertData();
            }
